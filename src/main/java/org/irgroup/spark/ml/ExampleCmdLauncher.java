...
public class ExampleCmdLauncher {
	...
	public ExampleCmdLauncher() {
		word2Vec = new Word2VecExample(ExampleCmdLauncher.class.getSimpleName());
	...
	{
		Dataset<Row> vectors = word2Vec.getWordVector(word);
	...
	public void printWord2WordSimilarity(String word, int count)
	{
		...
		// get word vector
		Dataset<Row> tempDF = word2Vec.getWordVector(word);
		if(tempDF == null)
		{
